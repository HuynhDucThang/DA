import PopupMessage from "@/components/layouts/modal/popupMessage";
  ...
  return (
    ...
    >
      ...
      >
        <div
          ref={childElement}
          className={`bg-white rounded-lg w-[700px] min-w-[400px] transition-all p-5 ${
